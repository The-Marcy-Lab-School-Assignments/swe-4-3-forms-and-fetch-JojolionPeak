...
The student doesn't call `event.preventDefault()`, so the user will be sent to the submit page. In order to solve this, they should call **event.preventDefault()** in the _very beginning of their code_.
